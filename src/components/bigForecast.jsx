    ...
    return (  
        <React.Fragment>
            <div className="parentFlex">
                ...
                <p className="middle_text">Humidity: {forecastValues.day.avghumidity}</p>
                <p className="middle_text">Total Percipitation: {forecastValues.day.totalprecip_mm} mm</p>
                </div>
                <div className="center_Flex">
                <Chart data={forecastValues.hour} big={true} className="big_chart"/>
                </div>
